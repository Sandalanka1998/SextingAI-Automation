describe('Dashboard', ()=> {
    ...
    it('Create Character', ()=> {
        ...
        cy.wait(2000)
        cy.get('.v-col-md-4 > .girl-infobox > :nth-child(1) > :nth-child(1) > .v-slide-group > .v-slide-group__container > .v-slide-group__content > [tabindex="-1"]').click() //Pictures
        cy.wait(3000)
        cy.get('.v-col-md-4 > .girl-infobox > :nth-child(1) > :nth-child(1) > .v-window > .v-window__container > .v-window-item--active > .v-row > :nth-child(1) > .v-responsive').should('be.visible') //Verify pictures display properly
        cy.get('.v-col-md-4 > .girl-infobox > :nth-child(1) > :nth-child(1) > .v-window > .v-window__container > .v-window-item--active > .v-row > :nth-child(2) > .v-responsive').should('be.visible') //Verify pictures display properly
        cy.get('.v-col-md-4 > .girl-infobox > :nth-child(1) > :nth-child(1) > .v-window > .v-window__container > .v-window-item--active > .v-row > :nth-child(3) > .v-responsive').should('be.visible') //Verify pictures display properly
        cy.wait(2000)
    })
    ...
    it('Chat Function', ()=> {
        ...
        cy.wait(2000)
        cy.get(':nth-child(1) > :nth-child(1) > .text-primary').click() //Delete chat and restart
        cy.wait(2000)
        //cy.get(':nth-child(3) > .v-col > .messagebox-container > .messagebox').should('not.be.visible'); 
        //cy.wait(2000) 

        //cy.get(':nth-child(1) > :nth-child(1) > .v-btn--block').click() //Delete Character 
